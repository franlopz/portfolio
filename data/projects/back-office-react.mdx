...
anytime and everywhere, it works for any bussiness, designed for El Salvador.
Display and export data, add purchases, manage suppliers. You can add multiple users
to a bussiness and track your finances quick and easy.'
...
The local government updated the platform to file taxes, it requires to upload `.csv` files with a specific format, because of the line of business, the application was required to export only files for a single tax form.
...
It must allow to store sales and purchases data according to local regulations.
